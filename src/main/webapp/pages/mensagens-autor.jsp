...
<button type="button" class="button danger sa-button sa-button-danger js-report" data-id="<%= comentario.getId_comentario() %>" data-user="<%= h(comentario.getNome_usuario()) %>">🚩 Denunciar</button>
      </div>
    </article>
  <% }} %>
  </section>
